...
public class Preferences{
    ...
    public static float partyMemberMaxDecideTime = 40.0f;
    public static float minRecipeCost = 6.0f;
    public static float maxRecipeCost = 14.0f;
    public static float flatPrice = 10.0f;
    public static int minPartyMemebers = 2;
    public static int maxPartyMemebers = 4;
}